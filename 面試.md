...
在大學時，我對於化學系統的模擬計算非常有興趣，也因此在大三加入了鄭原忠老師的實驗室進行理論模擬相關的專題研究。我們實驗室主要的方向是非平衡態量子統計力學。因此對於量子力學、熱力學以及統計力學我都有進行研讀。而在進行理論模擬計算時，由於研究對像通常非常複雜，因此時常會以電腦來輔助計算。在研究所時，為了設計以及改進計算用的程式，我也自學了 C 與 Python。
